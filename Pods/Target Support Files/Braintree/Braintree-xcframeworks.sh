...
install_xcframework "${PODS_ROOT}/Braintree/Frameworks/XCFrameworks/CardinalMobile.xcframework" "Braintree/ThreeDSecure" "framework" "ios-armv7_arm64" "ios-i386_x86_64-simulator"
