...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.3"
  spec.summary      = "PaymentHelper is used to config all of our payment gatewayConnector"
  ...
  spec.author             = { "iOS Team" => "ios@trioangle.com" }
  # Or just: spec.author    = "iOS Team"
  # spec.authors            = { "iOS Team" => "ios@trioangle.com" }
  # spec.social_media_url   = "https://twitter.com/iOS Team"
  ...
  spec.source_files  = "PaymentHelper/**/*.{h,m,swift}"
